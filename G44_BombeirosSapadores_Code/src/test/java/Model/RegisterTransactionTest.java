...
public class RegisterTransactionTest {
    ...
    public void testOverallPercentageDelays() {
        ...
        List<TransactionExecution> ltr2 = lOrg.get(1).getRTrans().getTransactions();
        ...
        TransactionExecution trans3 = new TransactionExecution(task, freel, endDate, delay, qow, new Payment(valueE, valueC));

        Task task4 = new Task("102", "task2", 12, 20, "Programming2", true, true);
        ...
        TransactionExecution trans4 = new TransactionExecution(task2, free2, endDate2, delay2, qow2, new Payment(valueE2, valueC2));
